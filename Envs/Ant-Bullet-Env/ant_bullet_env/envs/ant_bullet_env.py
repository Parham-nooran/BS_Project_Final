...
class Ant(WalkerBase):
    ...
    def __init__(self):
        WalkerBase.__init__(self, "ant.xml", "torso", action_dim=8, obs_dim=28, power=2.5, load_terrain=False)
...
class AntBulletEnv(WalkerBaseBulletEnv):
  ...
  def __init__(self, render=False):
    self.robot = Ant()
    WalkerBaseBulletEnv.__init__(self, self.robot, render, random=True, max_goal_dist=20, min_dist=2, max_dist=6, goal_from_keyboard=False)
