...
class MJCFBasedRobot(XmlBasedRobot):
  ...
  def reset(self, bullet_client):
    ...
    if (self.doneLoading == 0):
      ...
      quadruped = pybullet.loadURDF("Ant-Bullet-Env\\ant_bullet_env\\resources\\statics\\laikago\\laikago\\laikago.urdf",[0,0,.5],[0,0.5,0.5,0], flags=urdfFlags, useFixedBase=False)
      self.objects = quadruped
      #######################################################################
